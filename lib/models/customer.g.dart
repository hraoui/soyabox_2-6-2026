...
const CustomerSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'lastOrderDate': PropertySchema(
      id: 3,
      name: r'lastOrderDate',
      type: IsarType.dateTime,
    ),
...
void _customerSerialize(
  ...
  writer.writeDateTime(offsets[3], object.lastOrderDate);
  writer.writeString(offsets[4], object.name);
  writer.writeLong(offsets[5], object.orderCount);
  writer.writeString(offsets[6], object.phone);
  writer.writeDouble(offsets[7], object.totalSpent);
...
Customer _customerDeserialize(
  ...
  object.id = id;
  object.lastOrderDate = reader.readDateTime(offsets[3]);
  object.name = reader.readString(offsets[4]);
  object.orderCount = reader.readLong(offsets[5]);
  object.phone = reader.readString(offsets[6]);
  object.totalSpent = reader.readDouble(offsets[7]);
...
extension CustomerQueryFilter
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> lastOrderDateEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'lastOrderDate',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> lastOrderDateLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> lastOrderDateBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> orderCountEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> orderCountGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> orderCountLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> orderCountBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension CustomerQuerySortBy on QueryBuilder<Customer, Customer, QSortBy> {
  ...
  QueryBuilder<Customer, Customer, QAfterSortBy> sortByLastOrderDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastOrderDate', Sort.asc);
    });
  }

  QueryBuilder<Customer, Customer, QAfterSortBy> sortByLastOrderDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastOrderDate', Sort.desc);
    });
  }
  ...
  QueryBuilder<Customer, Customer, QAfterSortBy> sortByOrderCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'orderCount', Sort.asc);
    });
  }

  QueryBuilder<Customer, Customer, QAfterSortBy> sortByOrderCountDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CustomerQuerySortThenBy
  ...
  QueryBuilder<Customer, Customer, QAfterSortBy> thenByLastOrderDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastOrderDate', Sort.asc);
    });
  }

  QueryBuilder<Customer, Customer, QAfterSortBy> thenByLastOrderDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastOrderDate', Sort.desc);
    });
  }
  ...
  QueryBuilder<Customer, Customer, QAfterSortBy> thenByOrderCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'orderCount', Sort.asc);
    });
  }

  QueryBuilder<Customer, Customer, QAfterSortBy> thenByOrderCountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'orderCount', Sort.desc);
    });
  }
...
extension CustomerQueryWhereDistinct
  ...
  QueryBuilder<Customer, Customer, QDistinct> distinctByLastOrderDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'lastOrderDate');
    });
  }
  ...
  QueryBuilder<Customer, Customer, QDistinct> distinctByOrderCount() {
    return QueryBuilder.apply(this, (query) {
...
extension CustomerQueryProperty
  ...
  QueryBuilder<Customer, DateTime, QQueryOperations> lastOrderDateProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'lastOrderDate');
    });
  }
  ...
  QueryBuilder<Customer, int, QQueryOperations> orderCountProperty() {
    return QueryBuilder.apply(this, (query) {
