...
void _productPriceSerialize(
  ...
  writer.writeString(offsets[4], object.typeLabel);
...
extension ProductPriceQueryWhereSort
  ...
  QueryBuilder<ProductPrice, ProductPrice, QAfterWhere> anyProductId() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductPriceQueryWhere
  ...
  QueryBuilder<ProductPrice, ProductPrice, QAfterWhereClause> productIdEqualTo(
      int productId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductPrice, ProductPrice, QAfterWhereClause> productIdLessThan(
    int productId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductPrice, ProductPrice, QAfterWhereClause> productIdBetween(
    int lowerProductId,
    int upperProductId, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<ProductPrice, ProductPrice, QAfterWhereClause> typeEqualTo(
      String type) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'type',
  ...
  QueryBuilder<ProductPrice, ProductPrice, QAfterWhereClause> typeNotEqualTo(
      String type) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension ProductPriceQueryFilter
  ...
  QueryBuilder<ProductPrice, ProductPrice, QAfterFilterCondition> typeEqualTo(
    String value, {
  ...
  QueryBuilder<ProductPrice, ProductPrice, QAfterFilterCondition> typeLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<ProductPrice, ProductPrice, QAfterFilterCondition> typeBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<ProductPrice, ProductPrice, QAfterFilterCondition> typeEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductPrice, ProductPrice, QAfterFilterCondition> typeContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductPrice, ProductPrice, QAfterFilterCondition> typeMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ProductPriceQuerySortBy
  ...
  QueryBuilder<ProductPrice, ProductPrice, QAfterSortBy> sortByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.asc);
    });
  }

  QueryBuilder<ProductPrice, ProductPrice, QAfterSortBy> sortByTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.desc);
    });
  }

  QueryBuilder<ProductPrice, ProductPrice, QAfterSortBy> sortByTypeLabel() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'typeLabel', Sort.asc);
    });
  }

  QueryBuilder<ProductPrice, ProductPrice, QAfterSortBy> sortByTypeLabelDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductPriceQuerySortThenBy
  ...
  QueryBuilder<ProductPrice, ProductPrice, QAfterSortBy> thenByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.asc);
    });
  }

  QueryBuilder<ProductPrice, ProductPrice, QAfterSortBy> thenByTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.desc);
    });
  }

  QueryBuilder<ProductPrice, ProductPrice, QAfterSortBy> thenByTypeLabel() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'typeLabel', Sort.asc);
    });
  }

  QueryBuilder<ProductPrice, ProductPrice, QAfterSortBy> thenByTypeLabelDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'typeLabel', Sort.desc);
    });
  }
...
extension ProductPriceQueryWhereDistinct
  ...
  QueryBuilder<ProductPrice, ProductPrice, QDistinct> distinctByType(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductPrice, ProductPrice, QDistinct> distinctByTypeLabel(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ProductPriceQueryProperty
  ...
  QueryBuilder<ProductPrice, String, QQueryOperations> typeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'type');
    });
  }

  QueryBuilder<ProductPrice, String, QQueryOperations> typeLabelProperty() {
    return QueryBuilder.apply(this, (query) {
